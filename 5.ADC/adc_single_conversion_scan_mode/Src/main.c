...
void ADC_Init(void)
{
	...
	// 4. Multiple channel: PC0(ADC123_IN10), PC1(ADC123_IN11), PC2(ADC123_IN12)
	ADC1->SQR3 = 10 << ADC_SQR3_SQ1_Pos | (11 << ADC_SQR3_SQ2_Pos) | (12 << ADC_SQR3_SQ3_Pos) ;
